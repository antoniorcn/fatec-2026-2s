...
class ProjetoController(
    ...
    fun lerTodos() : List<ProjetoDTOResponse> {
        ...
        /*
            [
                Projeto(id=2, nome="Ferias Frustradas 2",
                descricao="Férias programas para 2027", dataInicio="2027-01-01",
                dataEntrega="2027-02-01", status="Planejamento"),

                Projeto(id=3, nome="Estudar para Lab. Desenv. Multipl.",
                descricao="Estudar para Lab. Desenv. Multipl.", dataInicio="2026-09-18",
                dataEntrega="2026-12-12", status="Em andamento")
            ]
         */
        /*
            [
                ProjetoDTOResponse(id=2, nome="Ferias Frustradas 2",
                descricao="Férias programas para 2027", dataInicio="2027-01-01",
                dataEntrega="2027-02-01", status="Planejamento"),

                ProjetoDTOResponse(id=3, nome="Estudar para Lab. Desenv. Multipl.",
                descricao="Estudar para Lab. Desenv. Multipl.", dataInicio="2026-09-18",
                dataEntrega="2026-12-12", status="Em andamento")
            ]
         */

//        val projetosDTOResponse : List<ProjetoDTOResponse> = projetos.map({
//            projeto -> mapper.toResponse( projeto )
//        })
//        return projetosDTOResponse
    }
